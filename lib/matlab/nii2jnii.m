...
%
%    A NIFTI-1 file parser and converter to the text and binary JNIfTI formats
...
%          nii.NIFTIHeader -  a structure containing the 1-to-1 mapped NIFTI-1 header
...
nii.NIFTIHeader.IntentCode=     nii0.hdr.intent_code;
...
nii.NIFTIHeader.SliceCode=      nii0.hdr.slice_code;
nii.NIFTIHeader.Unit=           nii0.hdr.xyzt_units;
...
nii.NIFTIHeader.A75GlobalLMax=  nii0.hdr.glmax;
...
nii.NIFTIHeader.QuaternB=       nii0.hdr.quatern_b;
nii.NIFTIHeader.QuaternC=       nii0.hdr.quatern_c;
nii.NIFTIHeader.QuaternD=       nii0.hdr.quatern_d;
nii.NIFTIHeader.QuaternXOffset= nii0.hdr.qoffset_x;
nii.NIFTIHeader.QuaternYOffset= nii0.hdr.qoffset_y;
nii.NIFTIHeader.QuaternZOffset= nii0.hdr.qoffset_z;
